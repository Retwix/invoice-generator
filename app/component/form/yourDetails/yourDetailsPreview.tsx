...
export const YourDetailsPreview: React.FC<YourDetails> = ({
  ...
  <div>
    <p className="text-[11px] text-neutral-400 font-semibold uppercase pb-1">Prestataire</p>
    ...
    <div className="text-xs text-neutral-500/80">
      {yourAddress ? <p>{yourAddress}</p> : <div className="rounded-md bg-neutral-100 h-4 w-3/6 animate-pulse my-2" />}
